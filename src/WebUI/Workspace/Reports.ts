import {AzResourceTypes} from "../../AzureService/Compute/AzResourceTypes";
...
export const REPORTS: Array<Report> = [
    {
        ...
        type: AzResourceTypes.NetworkInterface
    },
    {
        ...
        type: AzResourceTypes.NetworkSecurityGroup
    },
    {
    ...
    },
    {
        ...
        type: AzResourceTypes.ResourceGroup
    },
    {
        ...
        type: AzResourceTypes.ManagedDisk
    }/*,
    {
